...
Vous pouvez accéder au https://library.netapp.com/ecm/ecm_download_file/ECMLP2879854["Notes de mise à jour de ONTAP Select 9.10.1"^] pour afficher les détails de la version actuelle.
